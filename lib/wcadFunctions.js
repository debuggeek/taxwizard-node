...
var calcDiff = function(subjectSummary){
  return compSummary => {
    // console.log("compSummary:",compSummary);
    // console.log("subjectSummary:", subjectSummary);
    compSummary.locationFactor = calcLocationFactor(subjectSummary, compSummary);
    compSummary.livingAreaValueAdj = calcLivingAreaValAdj(subjectSummary, compSummary);
    compSummary.locationAdj = calcLocationAdj(subjectSummary, compSummary);
    compSummary.deprecationAdj = calcDeprecationAdj(subjectSummary, compSummary);
    compSummary.nonLivingAreaValueAdj = calcNonLivingAreaValueAdj(subjectSummary, compSummary);
    compSummary.landValueAdj = calcLandValueAdj(subjectSummary, compSummary);
    compSummary.adjustedSalePrice = calcAdjustedSalePriceAdj(compSummary);
    compSummary.adjustedEquityPrice = calcAdjustedEquityPrice(compSummary);
    return compSummary;
  };
}
